...
Following \cite{ji2014estimation}, we reparameterize the gene-variety mean structure into the gene-specific parental average ($\phi_g$), half-parental difference ($\alpha_g$), and hybrid difference ($\delta_g$). For our heterosis study where $V=3$, we let $v=1,2$ indicate the two parental varieties and $v=3$ indicate the hybrid. The reparameterization is  
