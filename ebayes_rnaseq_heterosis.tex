...
An RNAseq experiment to identify genes demonstrating heterosis consists of three genetic varieties: two parental varieties (P1 and P2) and a cross between these two varieties called the hybrid (H). For each variety, replicate RNA samples are isolated and assessed for quality. cDNA libraries are constructed and the samples are sequenced. These libraries are sequenced

loaded on flow cells, and sequenced. The raw sequencing reads 

\cite{nettleton2014design} and \cite{paschold2012complementation}
