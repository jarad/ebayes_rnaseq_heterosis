...
$\eta_\alpha$ & -0.017 & -0.023  & -0.018 & -0.014  \\
$\eta_\delta$ & -0.046 & -0.046 & -0.031  & -0.022   \\
$\eta_\psi$ & -2.7\phantom{00} & -2.3\phantom{00}  &  -2.3\phantom{00}  & -2.4\phantom{00} \\
\hline
$\sigma_\phi$ & 1.8\phantom{00} & 1.8\phantom{00}  & 1.8\phantom{00}  & 1.7\phantom{00} \\
$\sigma_\alpha$ & 0.36\phantom{0} & 0.46\phantom{0}  & 0.40\phantom{0}  & 0.36\phantom{0}  \\
$\sigma_\delta$ & 0.15\phantom{0} & 0.39\phantom{0}  & 0.32\phantom{0}  & 0.27\phantom{0}  \\
$\sigma_\psi$ & 0.74\phantom{0} & 0.40\phantom{0} & 0.49\phantom{0} & 0.54\phantom{0} \\
\hline
\end{tabular}
\end{table}
