...
r$ei = exp(r$integral-max(r$integral))
ggplot(r, aes(x=n_sims,y=ei))+geom_point() + scale_x_log10()


o = optim(rep(0,8), log_like, control = list(fnscale=-1))
