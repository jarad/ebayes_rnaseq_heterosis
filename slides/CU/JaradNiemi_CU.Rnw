...
\graphicspath{{../figs/}{../../include/}{../KState/}}
...
\title[Bayesian analysis for heterosis detection in RNAseq data]{Bayesian analysis for heterosis detection in RNAseq data}
